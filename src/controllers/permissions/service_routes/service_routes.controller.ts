...
const createAppServiceRoute = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        // // Validate Joi Schema
        const appRouteDetails: CreateAppServiceRouteType = await joiAppServiceRoute.createAppRouteSchema.validateAsync(req.body);
...
const updateAppServiceRoute = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        // Validate Joi Schema
        const appRouteDetails: UpdateAppServiceRouteType = await joiAppServiceRoute.updateAppRouteSchema.validateAsync(req.body);
...
const deleteAppRoute = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        // Validate Joi Schema
        const appRouteDetails: DeleteAppServiceRouteType = await joiAppServiceRoute.deleteAppRouteSchema.validateAsync(req.body);
