...
appTicketRouterV1.post('/all_my_sort_ticket', appAgentAuthController.getAllMySortTicket);
appTicketRouterV1.post('/all_search_ticket', appAgentAuthController.getAllSearchTicket);
appTicketRouterV1.post('/all_search_my_ticket', appAgentAuthController.getAllSearchMyTicket);
appTicketRouterV1.post('/upload_file', upload1.single('myfile'), appAgentAuthController.uploadFile);
appTicketRouterV1.post('/get_user', appAgentAuthController.getAllUser);
